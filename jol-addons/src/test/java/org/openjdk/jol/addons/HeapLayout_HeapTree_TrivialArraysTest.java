...
public class HeapLayout_HeapTree_TrivialArraysTest extends BaseHeapLayoutTest {
    ...
    void testByteArray() {
        ...
        thenHeapTreeIs( //
                "          COUNT   AVG SIZE   RAW AVG SZ TOTAL SIZE        RAW T SZ     RETAINED CT  PAR% R CT  RETAINED SZ        RAW R SZ  PAR% R SZ   DESCRIPTION\n"
                        ...
                        + "              1       24 B           24       24 B              24               1   100.00 %         24 B              24   100.00 %      +--[B\n");
    }
    ...
    void testDoubleArray() {
        ...
        thenHeapTreeIs( //
                "          COUNT   AVG SIZE   RAW AVG SZ TOTAL SIZE        RAW T SZ     RETAINED CT  PAR% R CT  RETAINED SZ        RAW R SZ  PAR% R SZ   DESCRIPTION\n"
                        + "              1       64 B           64       64 B              64               1   100.00 %         64 B              64   100.00 %   (total)\n"
                        + "              1       64 B           64       64 B              64               1   100.00 %         64 B              64   100.00 %      +--[D\n");
    }
    ...
    void testFloatArray() {
        ...
        thenHeapTreeIs( //
                "          COUNT   AVG SIZE   RAW AVG SZ TOTAL SIZE        RAW T SZ     RETAINED CT  PAR% R CT  RETAINED SZ        RAW R SZ  PAR% R SZ   DESCRIPTION\n"
                        ...
                        + "              1       40 B           40       40 B              40               1   100.00 %         40 B              40   100.00 %      +--[F\n");
    }
    ...
    void testIntegerArray() {
        ...
        thenHeapTreeIs( //
                "          COUNT   AVG SIZE   RAW AVG SZ TOTAL SIZE        RAW T SZ     RETAINED CT  PAR% R CT  RETAINED SZ        RAW R SZ  PAR% R SZ   DESCRIPTION\n"
                        ...
                        + "              1       32 B           32       32 B              32               1   100.00 %         32 B              32   100.00 %      +--[I\n");
    }
    ...
    void testLongArray() {
        ...
        thenHeapTreeIs( //
                "          COUNT   AVG SIZE   RAW AVG SZ TOTAL SIZE        RAW T SZ     RETAINED CT  PAR% R CT  RETAINED SZ        RAW R SZ  PAR% R SZ   DESCRIPTION\n"
                        ...
                        + "              1       48 B           48       48 B              48               1   100.00 %         48 B              48   100.00 %      +--[J\n");
    }
    ...
    void testObjectArray() {
        ...
        thenHeapTreeIs( //
                "          COUNT   AVG SIZE   RAW AVG SZ TOTAL SIZE        RAW T SZ     RETAINED CT  PAR% R CT  RETAINED SZ        RAW R SZ  PAR% R SZ   DESCRIPTION\n"
                        + "              1       48 B           48       48 B              48               1   100.00 %         48 B              48   100.00 %   (total)\n"
                        + "              1       48 B           48       48 B              48               1   100.00 %         48 B              48   100.00 %      +--[Ljava.lang.Object; [0 of 7 used (0.00 %)]\n");
    }
    ...
    void testShortArray() {
        ...
        thenHeapTreeIs( //
                "          COUNT   AVG SIZE   RAW AVG SZ TOTAL SIZE        RAW T SZ     RETAINED CT  PAR% R CT  RETAINED SZ        RAW R SZ  PAR% R SZ   DESCRIPTION\n"
                        + "              1       24 B           24       24 B              24               1   100.00 %         24 B              24   100.00 %   (total)\n"
                        + "              1       24 B           24       24 B              24               1   100.00 %         24 B              24   100.00 %      +--[S\n");
    }
}
